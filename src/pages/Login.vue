<style lang="less" type="text/less">
    #login {
        ...
        .content {
            ...
            padding-top: 54px;
            box-sizing: border-box;
            background: url(../assets/login_bg_max2.jpg) no-repeat;
...
<template>
    <div id="login">
        <header>
            <img class="logo" src="../assets/login_logo.jpg">
    ...
    export default {
        ...
        created: function () {
            ...
            this.$axios({
                ...
                routeThis.$store.state.exponent = data.exponent;
                routeThis.$store.state.modulus = data.modulus;
