...
<script>
    export default {
        ...
        methods:{
            getSffBusinessData: async function(param){
                await this.$axios({
                    ...
                    data:{
                        ...
                        if (result.data.error_msg) {
                            ...
                            this.businessParams.showSffline.data=result.data.data;
                        }
                })

            },
            //获取数据
            getBusinessData: async function(param){
                if (this.businessParams.showSffline!==undefined){
                    if (this.businessParams.showSffline.flag) {
                        await this.getSffBusinessData(this.businessParams.showSffline);
                    }
                }
                //清空数据
                this.submiter = {};
                ...
                this.$axios({
                    ...
                    if (result.data.error_msg) {
                        ...
                        if (this.businessParams.showSffline!==undefined&& this.businessParams.showSffline.data!==undefined) {
                            if (this.businessParams.showSffline.flag) {
                                data.submiter = this.businessParams.showSffline.data.submiter;
                                data.history = this.businessParams.showSffline.data.history.concat( data.history);
                            }
                        }
