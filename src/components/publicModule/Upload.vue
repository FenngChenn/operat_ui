    ...
    <div id="upload">
        <ul class="file-list">
            <li v-for="file in fileList">
                <row @click="downloadUpFile(file.object_id)" :class="file.file_extension_suffix" title="点击下载">
                    <span :class="file.file_extension_suffix" title="点击下载"></span>{{ file.original_file_name }}</row>
    ...
    export default {
        ...
        methods:{
            ...
            beforeUpload:function(file){
                ...
                if(!set.has(suffix)) {
                  this.$message.error('非法文件类型[' + suffix + ']');
                  return false;
                }
