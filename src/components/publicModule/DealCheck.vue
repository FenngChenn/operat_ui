            ...
            <div class="search-setion">
                <el-form :inline="true" :model="searchData" size="mini">
                    <el-row>
                        ...
                        <el-col :span="4">
                            <el-form-item>
                                <el-input v-model="searchData.pay_account_no" placeholder="请输入付款方账号" clearable></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="4" v-if="isPending">
                            <el-form-item>
                                <el-input v-model="searchData.recv_account_no" placeholder="请输入收款方账号" clearable></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item>
                        ...
                        <el-col :span="4" v-if="showpaymode">
                            <el-form-item>
                                <el-select v-model="searchData.pay_mode"  placeholder="请选择支付方式"
                                           clearable filterable
                                           style="width:100%">
                                    <!--<el-option kay="1" value="1" label="银企直连" aria-checked="true"></el-option>-->
                                    <el-option v-for="(paymode,key) in paymodList"
                                               :key="key"
                                               :label="paymode"
                                               :value="key">
                                    </el-option>
            ...
            <section class="table-content" v-if="isPending">
                <el-table :data="tableList" border
                    ...
                    <el-table-column prop="bill_no" label="报销单申请号" :show-overflow-tooltip="true"
                                     v-if="showbillno"></el-table-column>
                    ...
                    <el-table-column prop="pay_mode" label="支付方式" :show-overflow-tooltip="true"
                                     v-if="showpaymode"></el-table-column>
...
<script>
    export default {
        ...
        created: function () {
            ...
            //收款方式
            if(constants.FKPayMode){
                this.paymodList = constants.FKPayMode;
            }
        },
        mounted: function () {
        },
        ...
        methods: {
            ...
            setOptypes: function (queryData) {
                ...
                if (queryData.bizType == "48") { //总公司付款
                    this.routerMessage.todo.optype = "headorgfkcheck_checkbillList";
                    this.routerMessage.done.optype = "headorgfkcheck_checkbillList";
                    this.checkOptype = "headorgfkcheck_checkTradeList";
                    this.confirmOptype = "headorgfkcheck_confirmCheck";
                    this.validatedOptype = "headorgfkcheck_checkAlreadyTradeList";
            ...
            setBatchOptype: function (queryData) {
                ...
                if (queryData.bizType == "48") { //分公司付款
                    this.routerMessage.todo.optype = "branchorgfkcheck_checkbillList";
                    this.routerMessage.done.optype = "branchorgfkcheck_checkbillList";
                    this.checkOptype = "branchorgfkcheck_checkTradeList";
                    this.confirmOptype = "branchorgfkcheck_confirmCheck";
                    this.validatedOptype = "branchorgfkcheck_checkAlreadyTradeList";
